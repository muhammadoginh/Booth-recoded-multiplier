...
HD_PWD='C:/Users/User/Documents/Projects/Booth-recoded multiplier/Booth-recoded multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_Recoded_Mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Booth_Recoded_Mult.tcl
