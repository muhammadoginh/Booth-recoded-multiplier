...
HD_PWD='C:/Users/User/Documents/Projects/Booth-recoded multiplier/Booth-recoded multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_Recoded_Mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Booth_Recoded_Mult.tcl -notrace
